...
export async function GET(
  ...
  try {
    ...
    const translation = await translationService.getTranslationById(resolvedParams.id);
...
export async function PATCH(
  ...
  try {
    ...
    if (body.action === 'cancel') {
      ...
      const cancelledTranslation = await translationService.cancelTranslation(resolvedParams.id);
