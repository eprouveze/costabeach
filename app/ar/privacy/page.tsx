...
export const metadata: Metadata = {
  title: "سياسة الخصوصية - كوستا بيتش",
  description: "سياسة الخصوصية لمنصة إدارة العقارات كوستا بيتش",
};

export default async function PrivacyPage() {
  const { t, isRTL } = await useTranslation('ar');

  return (
    <div className={`min-h-screen bg-gray-50 py-12 ${isRTL ? 'rtl' : ''}`}>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-6">
              {t('privacy.lastUpdated')}: {new Date().toLocaleDateString('ar-MA')}
            </p>
            ...
            <section className="mb-8">
              ...
              <div className={`${isRTL ? 'mr-4' : 'ml-4'}`}>
                ...
                <ul className={`list-disc ${isRTL ? 'pr-6' : 'pl-6'} text-gray-700`}>
